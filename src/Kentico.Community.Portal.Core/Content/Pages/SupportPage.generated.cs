...
{
	/// <summary>
	/// Represents a page of type <see cref="SupportPage"/>.
	/// </summary>
	[RegisterContentTypeMapping(CONTENT_TYPE_NAME)]
	public partial class SupportPage : IWebPageFieldsSource, IWebPageMetaFields, IBasicItemFields
	{
		/// <summary>
		/// Code name of the content type.
		/// </summary>
		public const string CONTENT_TYPE_NAME = "KenticoCommunity.SupportPage";
