...
public class MemberAnniversary2YearMemberBadgeAssignmentRule(TimeProvider time) : IMemberBadgeAssignmentRule
{
    private readonly TimeProvider time = time;

    public string BadgeCodeName => "MemberAnniversary2Year";
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var member in members)
        {
            ...
            if (now < member.MemberCreated.AddYears(2))
            {
                continue;
            }
