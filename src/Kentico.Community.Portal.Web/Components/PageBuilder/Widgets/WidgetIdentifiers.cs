...
using Kentico.Community.Portal.Web.Components.PageBuilder.Widgets.PageHeading;
...
public static class WidgetIdentifiers
{
    ...
    public const string Login = LoginWidget.IDENTIFIER;
    ...
    public const string Register = RegistrationWidget.IDENTIFIER;
    public const string Testimonial = TestimonialWidget.IDENTIFIER;
