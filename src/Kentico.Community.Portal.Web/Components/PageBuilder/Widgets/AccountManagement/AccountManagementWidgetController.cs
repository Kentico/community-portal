...
[Authorize]
public class AccountManagementWidgetController(
    ...
    IWebPageUrlRetriever urlRetriever) : Controller
{
    ...
    public async Task<ActionResult> UpdateProfile(ProfileViewModel model)
    {
        ...
        {
            return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_ProfileForm.cshtml", model);
        }
        ...
        return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_ProfileForm.cshtml", new ProfileViewModel
        {
    ...
    public async Task<ActionResult> UpdatePassword(UpdatePasswordViewModel model)
    {
        ...
        if (!ModelState.IsValid)
        {
            return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_PasswordForm.cshtml", model);
        }
        ...
        return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_PasswordForm.cshtml", new UpdatePasswordViewModel());
    }
    ...
    public async Task<ActionResult> UpdateAvatarImage(AvatarFormViewModel model)
    {
        ...
        if (!ModelState.IsValid)
        {
            return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_AvatarForm.cshtml", model);
        }
    ...
    public async Task<ActionResult> UpdateSelectedBadges(UpdateBadgesRequest request)
    {
        ...
        return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_BadgesForm.cshtml", new BadgesFormViewModel(badges));
    }
    ...
    public async Task<ActionResult> UpdateQAndANotifications(QAndANotificationsFormViewModel model)
    {
        ...
        return PartialView("~/Components/PageBuilder/Widgets/AccountManagement/_DiscussionNotificationsForm.cshtml", updatedModel);
    }
...
public class ProfileViewModel
{
    ...
    [BindNever]
    public IReadOnlyList<SelectListItem> TimeZoneOptions { get; } =
        [.. TimeZoneInfo.GetSystemTimeZones().Select(tz => new SelectListItem(tz.DisplayName, tz.Id))];
}
