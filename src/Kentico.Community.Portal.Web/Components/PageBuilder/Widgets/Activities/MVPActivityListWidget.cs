...
using Kentico.Community.Portal.Web.Components.PageBuilder.Widgets.MVPActivityList;
...
namespace Kentico.Community.Portal.Web.Components.PageBuilder.Widgets.MVPActivityList;
...
public class MVPActivityListWidget(IMediator mediator) : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(ComponentViewModel<MVPActivityListWidgetProperties> _)
    {
        ...
        return View("~/Components/PageBuilder/Widgets/Activities/MVPActivityList.cshtml", new MVPActivityListWidgetViewModel(resp, communityMemberID.Value)
        {
