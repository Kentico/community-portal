...
namespace Kentico.Community.Portal.Web.Components.PageBuilder.Widgets.PageHeading;
...
public class PageHeadingWidget : ViewComponent
{
    ...
    public IViewComponentResult Invoke(ComponentViewModel<PageHeadingWidgetProperties> vm)
    {
        ...
        return View("~/Components/PageBuilder/Widgets/PageHeading/PageHeading.cshtml", model);
    }
}
