...
namespace Kentico.Community.Portal.Web.Components.ViewComponents.PollFormResults;
...
public class PollFormResultsViewComponent(IMediator mediator) : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(PollResultsProperties props)
    {
        ...
        return View("~/Components/ViewComponents/PollFormResults/PollFormResults.cshtml", new PollFormResultsViewModel(
            formData,
