...
using Kentico.Community.Portal.Web.Components.Widgets.CommunityGroupCard;
...
namespace Kentico.Community.Portal.Web.Components.Widgets.CommunityGroupCard;
...
public class CommunityGroupCardWidget(IMediator mediator) : ViewComponent
{
    ...
    public async Task<IViewComponentResult> InvokeAsync(ComponentViewModel<CommunityGroupCardWidgetProperties> vm)
    {
        ...
        return Validate(resp)
            .Match(
                vm => View("~/Components/Widgets/CommunityGroupCard/CommunityGroupCard.cshtml", vm),
