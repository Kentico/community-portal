...
public class QAndAEditPage : InfoEditPage<QAndAAnswerDataInfo>
{
    ...
    public QAndAEditPage(IFormComponentMapper formComponentMapper, IFormDataBinder formDataBinder, ISystemClock clock)
             : base(formComponentMapper, formDataBinder) => this.clock = clock;
